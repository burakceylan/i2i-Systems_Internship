 ...
 * 
 */
@WebServiceClient(name = "CalculatorServiceService", targetNamespace = "http://com/", wsdlLocation = "http://localhost:8080/CalculatorWebApp/CalculatorServiceService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICESERVICE_QNAME = new QName("http://com/", "CalculatorServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/CalculatorWebApp/CalculatorServiceService?wsdl");
    ...
    public CalculatorService getCalculatorServicePort() {
        return super.getPort(new QName("http://com/", "CalculatorServicePort"), CalculatorService.class);
    }
    ...
    public CalculatorService getCalculatorServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://com/", "CalculatorServicePort"), CalculatorService.class, features);
    }
